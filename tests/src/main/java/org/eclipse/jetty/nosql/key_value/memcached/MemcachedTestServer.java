...
import org.eclipse.jetty.nosql.key_value.memcached.spymemcached.BinarySpyMemcachedClientFactory;
import org.eclipse.jetty.nosql.key_value.memcached.spymemcached.HerokuSpyMemcachedClientFactory;
import org.eclipse.jetty.nosql.key_value.memcached.spymemcached.SpyMemcachedClientFactory;
import org.eclipse.jetty.nosql.key_value.memcached.xmemcached.BinaryXMemcachedClientFactory;
import org.eclipse.jetty.nosql.key_value.memcached.xmemcached.XMemcachedClientFactory;
...
public class MemcachedTestServer extends AbstractTestServer
{
    ...
    {
        this(port, maxInactivePeriod, scavengePeriod, System.getProperty("org.eclipse.jetty.nosql.key_value.memcached.servers"));
    }
    ...
    public AbstractMemcachedClientFactory getMemcachedClientFactory() {
        String useBinary = System.getProperty("org.eclipse.jetty.nosql.key_value.memcached.useBinary", "false").trim().toLowerCase(); // backward compatibility
        String cfName = System.getProperty("org.eclipse.jetty.nosql.key_value.memcached.clientFactory", "default").trim().toLowerCase();
